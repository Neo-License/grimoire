...
| Vulnerability remediation | Triaged findings → bug-tracker tickets, risk-accept register with expiry (feeds back into triage), change stubs for non-trivial fixes | Vuln-remediate skill |
